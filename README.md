...
O objetivo é apresetar uma API implementada seguindo o estilo REST.

As principais tecnologias que serão utilizadas:
...
```
$ docker run -d -p 8000:8000 --name django docker_django
```
